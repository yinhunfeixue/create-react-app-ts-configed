import { Col, Form, Input, Menu, Modal, Radio, Row, Select } from 'antd'
...
class SearchView extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            busiGroupId: '',
            sourceBusiGroupId: '',
            radioOptions: this.props.radioOptions ? this.props.radioOptions : [{ label: '搜索视图', value: '1' }, { label: '中间结果表', value: '2' }],
                    ...
                    <Row>
                        <Col span={24} >
                            <Form>
                                ...
                                {
                                    this.state.type == 2 && this.state.importFrom == 'kws' ? <Form.Item
                                        wrapperCol={{ span: 24 }}
                                            ...
                                            <Select style={{ width: '89%' }} value={busiGroupId} onChange={this.handleChange.bind(this, 'busiGroupId')} >
                                                {
                                                    _.map(categoryList, (val, key) => {
                                                        ...
                                                        return (
                                                            <Select.Option key={keyName} value={val.busiGroupId}>{val.busiGroupName}</Select.Option>
                                                        )
                                                    })
                                                }
                                            </Select>
