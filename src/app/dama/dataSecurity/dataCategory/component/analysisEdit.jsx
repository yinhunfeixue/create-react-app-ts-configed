...
export default class DataWareEditDrawer extends Component {
    ...
    openEditModal = async (parentInfo, data, treeData) => {
        console.log('open edit', parentInfo)
    ...
    render() {
        ...
        let businessTagDesc = addType == 1 ? '分析主题' : addType == 2 ? '分析主题' : ''
        ...
        const that = this
        console.log('drawer render', addType)
        return (
            <DrawerLayout
                drawerProps={{
