...
export default class SearchResult extends Component {
        ...
        if (params.sourceData && params.sourceDataCode) {
            this.setState(
                ...
                () => {
                    ...
                    this.handleChartToolBarClick({ key: 'sql' })
                }
            )
        } else {
            this.searchRenderView()
    ...
    sqlRender = () => {
        this.setState({
            ...
            chartSetting: this.state.sourceData.sql,
        })
    }
    ...
    render() {
        ...
        return (
            <div className='kwSearchMainContent'>
                {sourceDataCode === 500 ? (
                    <div className='promptUserWrong'>
                        <span>出错啦</span>
                        {SvgChart['Wrong']['img']}
                    </div>
                ) : sourceDataCode === 200 && sourceData.total != undefined ? (
                    <Collapse activeKey='1'>
                        <Panel
                            key='1'
                            showArrow={false}
                            header={chartSettingTitle}
                            extra={
                ...
                <TableDetail
                    ref={(dom) => {
                        this.detailTable = dom
                    }}
                    handleDetail={this.props.funcs.handleDetail}
                />

                <Dashboard
                    ref={(dom) => {
                        this.dashboardDom = dom
                    }}
                ...
                <SearchView
                    ...
                    importFrom={this.props.importFrom}
                    handleAddSearchView={this.handleAddSearchView}
                    radioOptions={this.props.searchViewRadioOptions}
                />
            </div>
        );
    }
